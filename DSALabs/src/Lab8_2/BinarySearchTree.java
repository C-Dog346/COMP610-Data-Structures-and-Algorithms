...
/**
   ...
   @author Andrew Ensor
   * 
   * Traversing children at not 'i' can get children at indicies max number of children
   * (k) * i + 1/2/3. AKA node index * 3 + child number
   * 
*/
   ...
   implements SortedSet<E>
{
   ...
   protected class BinaryTreeNode
   {
    ...
    private class BinaryTreeIterator implements Iterator<E>
    {
        ...
        // MUST PASS IN THE ORDER WHEN CREATING IT
        // CODE IS DONE INSIDE iterator() ON LINE 230
        public BinaryTreeIterator(BinaryTreeNode rootNode, String order)
